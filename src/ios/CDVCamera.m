...
- (void)imagePickerControllerReturnImageResult
{
    ...
    if (self.metadata) {
        ...
        NSMutableDictionary *metadataAsMutable = [self.metadata mutableCopy];
        ...
        CGImageDestinationAddImageFromSource(destinationImage, sourceImage, 0, (__bridge CFDictionaryRef)metadataAsMutable);
